...
for trait, cfg_key in (
    ...
    ('concurrent_spawn_limit', "concurrent_spawn"),
    # Max number of servers to be running at one time
    ('active_server_limit', "active_server"),
    # base url prefix
    ('base_url', None),
...
c.JupyterHub.authenticator_class = "earthauthenticator.EarthAuthenticator"
